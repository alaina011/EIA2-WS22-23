...
(function (A10_Polymorphie) {
    ...
    function createMoveObjects() {
        ...
        for (let iBird = 0; iBird < 15; iBird++) {
            let bird = new A10_Polymorphie.Bird("brown");
    ...
    function drawStanding() {
        ...
        A10_Polymorphie.crc2.translate(x, y);
        A10_Polymorphie.crc2.beginPath();
        A10_Polymorphie.crc2.fillStyle = "black";
        A10_Polymorphie.crc2.arc(0, 0, 10, 0, 2 * Math.PI);
        // body
        A10_Polymorphie.crc2.ellipse(-25, 20, 10, 25, 20, 0, 360);
        A10_Polymorphie.crc2.moveTo(-30, 30);
        A10_Polymorphie.crc2.lineTo(-30, 53);
        A10_Polymorphie.crc2.moveTo(-25, 30);
        A10_Polymorphie.crc2.lineTo(-25, 53);
        A10_Polymorphie.crc2.fill();
        // beak
        A10_Polymorphie.crc2.moveTo(1, -5);
        A10_Polymorphie.crc2.lineTo(20, -5);
        A10_Polymorphie.crc2.lineTo(1, 2);
        A10_Polymorphie.crc2.stroke();
        A10_Polymorphie.crc2.strokeStyle = "black";
    ...
    A10_Polymorphie.randomNumber = randomNumber;
    function drawBackground() {
        let gradient = A10_Polymorphie.crc2.createLinearGradient(0, 0, 0, A10_Polymorphie.crc2.canvas.height);
        gradient.addColorStop(0, "lightblue");
        gradient.addColorStop(horizont, "lightgrey");
        gradient.addColorStop(1, "#C7F9CD");
        A10_Polymorphie.crc2.fillStyle = gradient;
        A10_Polymorphie.crc2.fillRect(0, 0, A10_Polymorphie.crc2.canvas.width, A10_Polymorphie.crc2.canvas.height);
        let startMountain = A10_Polymorphie.crc2.canvas.height * horizont;
        ...
        drawStanding();
        background = A10_Polymorphie.crc2.getImageData(0, 0, A10_Polymorphie.crc2.canvas.width, A10_Polymorphie.crc2.canvas.height);
    }
    function drawSun(_position) {
        let sunCircle = A10_Polymorphie.canvas.getContext("2d");
        let r1 = 25;
        let r2 = 150;
        let gradient = A10_Polymorphie.crc2.createRadialGradient(0, 0, r1, 0, 0, r2);
    ...
    function drawCloud(_position, _size) {
        let cloudCircle = A10_Polymorphie.canvas.getContext("2d");
        let nParicles = 20;
        let radiusParticle = 50;
        let particle = new Path2D();
        let gradient = A10_Polymorphie.crc2.createRadialGradient(0, 0, 0, 0, 0, radiusParticle);
    ...
    function drawMountain(_position, _min, _max, _colorLow, _colorHigh) {
        let mountainLine = A10_Polymorphie.canvas.getContext("2d");
        let stepMin = 100;
        let stepMax = 200;
        let x = 0;
        mountainLine.save();
    ...
    function drawTree(_position, _max) {
        let tree = A10_Polymorphie.canvas.getContext("2d");
        // Tree Trunk
        tree.save();
    ...
    function drawSnowman(_position) {
        let snowmanCircle = A10_Polymorphie.canvas.getContext("2d");
        let r1 = 60;
        let r2 = 50;
        let r3 = 40;
        snowmanCircle.save();
    ...
    function drawBirdhouse(_position) {
        let house = A10_Polymorphie.canvas.getContext("2d");
        // Trunk
        house.save();
